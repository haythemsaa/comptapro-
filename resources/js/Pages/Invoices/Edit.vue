<template>
    <AuthenticatedLayout>
        <template #header>
            <h2 class="h4 mb-0">Modifier {{ invoice.invoice_number }}</h2>
        </template>

        <div class="py-4">
            <div class="container-fluid">
                <div v-if="invoice.status !== 'draft'" class="alert alert-warning mb-4">
                    <i class="bi bi-exclamation-triangle me-2"></i>
                    Seules les factures en brouillon peuvent être modifiées.
                    <Link :href="route('invoices.show', invoice.id)" class="alert-link ms-2">
                        Retour à la facture
                    </Link>
                </div>
                            ...
                            <div class="card sticky-top" style="top: 1rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <Link :href="route('invoices.show', invoice.id)" class="btn btn-secondary">
                                            Annuler
                                        </Link>
                                    </div>
                                </div>
...
const submit = () => {
    router.put(route('invoices.update', props.invoice.id), form);
};
</script>
