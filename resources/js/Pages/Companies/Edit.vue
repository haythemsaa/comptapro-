<template>
    <AuthenticatedLayout>
        <template #header>
            <h2 class="h4 mb-0">Modifier {{ company.name }}</h2>
        </template>
                            ...
                            <div class="card-body">
                                <form @submit.prevent="submit">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <Link :href="route('companies.show', company.id)" class="btn btn-secondary">
                                            Annuler
                                        </Link>
                                    </div>
                                </form>
...
const submit = () => {
    router.put(route('companies.update', props.company.id), form);
};
</script>
