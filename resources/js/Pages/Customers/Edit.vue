                ...
                <div class="header-content">
                    <div class="header-left">
                        ...
                        <div>
                            ...
                            <p class="page-subtitle">{{ customer.name }} - {{ customer.customer_number }}</p>
                        </div>
                    </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                <label class="checkbox-label">
                                    ...
                                    />
                                    <span class="checkbox-text">Client actif</span>
                                </label>
                            </div>
                        </div>
                    </div>
...
const submit = () => {
    form.put(route('customers.update', props.customer.id), {
        onSuccess: () => {
            window.$toast?.success('Client mis à jour avec succès', 'Succès');
        },
        onError: () => {
